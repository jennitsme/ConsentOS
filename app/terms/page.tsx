    ...
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-zinc-300">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p>
            ConsentOS is a platform that allows users to monitor, manage, and control their data permissions 
            across various third-party applications and services.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">3. User Data and Privacy</h2>
          <p>
            We respect your privacy and are committed to protecting your personal data. Our collection and 
            use of your information are governed by our Privacy Policy. By using the Service, you consent 
        ...
        <section>
          ...
          <p>
            The Service allows you to connect with third-party platforms (e.g., Google, Twitter). 
            Your use of these third-party services is governed by their respective terms of service 
            and privacy policies. ConsentOS is not responsible for the practices of any third-party services.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            any material changes. Your continued use of the Service after such modifications constitutes 
